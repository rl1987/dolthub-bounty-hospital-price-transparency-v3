...
def main():
    targets = {
        "033302": "https://phoenixchildrens.pt.panaceainc.com/MRFDownload/phoenixchildrens/phoenixchildrens"
    }
    ...
    for cms_id in targets.keys():
        ...
        h_f.write(
            'UPDATE `hospitals` SET `homepage_url` = "https://www.phoenixchildrens.org/", `chargemaster_url` = "{}", `last_edited_by_username` = "rl1987" WHERE `cms_certification_num` = "{}";\n'.format(
                url, cms_id
            )
        )
