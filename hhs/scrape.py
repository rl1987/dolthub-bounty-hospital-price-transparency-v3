...
def main():
    targets = {
        ...
        "121306": "https://hhsc.pt.panaceainc.com/MRFDownload/hhsc/mahelona",
        "120005": "https://hhsc.pt.panaceainc.com/MRFDownload/hhsc/hilo",
        "121307": "https://hhsc.pt.panaceainc.com/MRFDownload/hhsc/hale",
    ...
    for cms_id in targets.keys():
        ...
        h_f.write(
            'UPDATE `hospitals` SET `homepage_url` = "https://www.hhsc.org/", `chargemaster_url` = "{}", `last_edited_by_username` = "rl1987" WHERE `cms_certification_num` = "{}";\n'.format(
                url, cms_id
            )
        )
