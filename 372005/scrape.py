...
def main():
    ...
    resp = requests.get(
        "https://28g1xh366uy0x9ort41hns72-wpengine.netdna-ssl.com/wp-content/uploads/2021/12/Oklahoma-City-Price-Transparency-01-2022.xlsx",
        headers=headers,
    )
    print(resp)
    print(resp.url)
    ...
    out_f = open("372005.csv", "w", encoding="utf-8")
