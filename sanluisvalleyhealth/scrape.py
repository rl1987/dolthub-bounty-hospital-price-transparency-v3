...
def main():
    targets = {
        "060008": "https://sanluis.pt.panaceainc.com/MRFDownload/sanluis/slvhealth",
        "061308": "https://sanluis.pt.panaceainc.com/MRFDownload/sanluis/conejos"
    }
    ...
    for cms_id in targets.keys():
        ...
        h_f.write(
            'UPDATE `hospitals` SET `homepage_url` = "https://www.sanluisvalleyhealth.org/", `chargemaster_url` = "{}", `last_edited_by_username` = "rl1987" WHERE `cms_certification_num` = "{}";\n'.format(
                url, cms_id
            )
        )
